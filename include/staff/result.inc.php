...
//echo "<a HREF='admin.php?t=printreport'> click to save file </a>";
}
...
echo "<br><br><p style='font-size:16px'><a HREF='admin.php?t=printreport'> click to save to file </Font></a></p></div>";
